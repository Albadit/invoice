            ...
            <div className="grid grid-cols-2 gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                {invoice.discount_total_amount != null && (
                  <div className="flex justify-between text-default-600">
                    <span className="text-default-600">{tl(labels, 'fields.discount') || 'Discount'} ({invoice.discount_type === 'percent' ? `${invoice.discount_amount}%` : (invoice.currency?.symbol || '$') + invoice.discount_amount}):</span>
                ...
                {invoice.tax_total_amount != null && (
                  <div className="flex justify-between text-default-600">
                    <span className="text-default-600">{tl(labels, 'fields.tax') || 'Tax'} ({invoice.tax_type === 'percent' ? `${invoice.tax_amount}%` : (invoice.currency?.symbol || '$') + invoice.tax_amount}):</span>
